    ...
    <>
      <div className={styles.mobileBar}>
        <Link className={styles.mobileBrand} href="/dashboard" aria-label="NeoTravel - tableau de bord">
          <Image src="/logo-neotravel-v12.svg" alt="" width={28} height={28} priority />
        ...
        <div className={styles.navTop}>
          <Link className={styles.brand} href="/" aria-label="NeoTravel - retour accueil">
            <span className={styles.brandMark} aria-hidden="true">
              <Image src="/logo-neotravel-v12.svg" alt="" width={36} height={36} priority />
            </span>
            <span>
              <strong>NeoTravel</strong>
              <span>{isAdmin ? "admin" : "commercial"}</span>
            </span>
          </Link>
          <button
            type="button"
