  ...
  return (
    <div className={styles.actionGrid}>
      ...
      <article className={styles.actionCard}>
        ...
        <p>Consulter la politique cookies, les durées de conservation et modifier vos choix.</p>
        <Link className={styles.secondaryButton} href="/client/confidentialite#cookies">
          Voir la politique
        </Link>
      </article>
    </div>
